import numpy as np
from core.ScaleSpace.SparseMatrixOperations import JaccardMatrix
...
class ScaleSpaceTree:
    ...
    def _set_linkage(self, row_col_val_info, unique_labels_previous_scale, unique_labels_current_scale):
        ...
        """
        # sort by columns, then by descending jaccard sim value (sort by second key important for direct link)
